...
export default function Signal() {
    return (
        <div className="pointer-events-auto w-full max-w-[400px] flex flex-col gap-[30px] font-mono text-[#ececec]" style={{ paddingLeft: '25px', paddingRight: '25px', boxSizing: 'border-box' }}>
